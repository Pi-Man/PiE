...
// ** though not intended it is possible to attach one component to multiple game objects
...
struct Component {
	...
	std::vector<std::pair<Uint32, std::function<void(PiE::EngineContext&, SDL_Event)>>> events;
