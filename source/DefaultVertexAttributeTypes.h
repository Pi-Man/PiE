#ifndef _DEFAULT_VERTEX_ATRIBUTE_TYPES_H
#define _DEFAULT_VERTEX_ATRIBUTE_TYPES_H
...
namespace PiE {
	...
	const extern VertexAttributeType COLOR3_F;
	...
	const extern VertexAttributeType COLOR3_D;
